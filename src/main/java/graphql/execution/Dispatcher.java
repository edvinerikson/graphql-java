...
public class Dispatcher {
    ...
    void addFields(String label, ResultPath path, Supplier<CompletableFuture<Object>> data, Supplier<List<GraphQLError>> errorSupplier, InstrumentationContext<PatchExecutionResult> instrumentationContext) {
        ...
        data.get().whenComplete((dataResult, throwable) -> {
